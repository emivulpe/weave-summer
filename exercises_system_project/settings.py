...
ALLOWED_HOSTS = ["localhost","127.0.0.1","trace.dcs.gla.ac.uk"]
...
ROOT_URLCONF = 'exercises_system_project.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'exercises_system_project.wsgi.application'
