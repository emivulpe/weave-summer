...
var bkExtend=function(){
	var A=arguments;
	if(A.length==1){A=[this,A[0]]}for(var B in A[1]){A[0][B]=A[1][B]}return A[0]
};
function bkClass(){
...
var bkLib={
	...
	toArray:function(C){var B=C.length,A=new Array(B);
		while(B--){
			A[B]=C[B]
		}return A
	},
...
var nicEditorConfig = bkClass.extend({
	...
	iconList : {"bgcolor":1,"forecolor":2,"bold":3,"center":4,"hr":5,"custom_indent":6,"indent":6,"italic":7,"justify":8,"left":9,"ol":10,"outdent":11,"custom_outdent":11,"removeformat":12,"right":13,"save":24,"strikethrough":15,"subscript":16,"superscript":17,"ul":18,"underline":19,"image":20,"link":21,"unlink":22,"close":23,"arrow":25}
...
var nicEditorColorButton=nicEditorAdvancedButton.extend({
	...
	colorSelect:function(A){this.ne.nicCommand("foreColor",A);this.removePane()},
