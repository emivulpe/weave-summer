                    ...
                    if (key == "explanation_area"){
                        ...
                        if (key == "question"){
                            ...
                            for (var i = 0; i < questionOptions.length; i++){
                                ...
                                $("#options_list").append('<li class="list-group-item option"><table style = "width:100%;"><tr><th><input type="checkbox"></th><th><input class="form-control option_text" type="text" value=' + questionOptions[i] + '></th></tr></table></li>');
                            }
